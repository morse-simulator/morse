...
GPS.configure_mw('yarp', ['Yarp', 'post_json_message', 'morse/middleware/yarp/json_mod'])
Motion_Controller.configure_mw('yarp', ['Yarp', 'read_json_waypoint', 'morse/middleware/yarp/json_mod'])
Rosace_Sensor.configure_mw('yarp', ['Yarp', 'post_json_message', 'morse/middleware/yarp/json_mod'])
Proximity_Sensor.configure_mw('yarp', ['Yarp', 'post_json_message', 'morse/middleware/yarp/json_mod'])

Rosace_Sensor_001.configure_mw('yarp', ['Yarp', 'post_json_message', 'morse/middleware/yarp/json_mod'])
GPS_001.configure_mw('yarp', ['Yarp', 'post_json_message', 'morse/middleware/yarp/json_mod'])
