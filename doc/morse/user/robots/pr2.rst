...
``$MORSE_ROOT/data/morse/robots/pr2/pr2.dae``
The imported .blend file can be found at:
``$MORSE_ROOT/data/morse/robots/pr2/pr2_25_original.blend``
...
``$MORSE_ROOT/data/morse/robots/pr2/pr2_25_rename.blend``
...
``$MORSE_ROOT/data/morse/robots/pr2/pr2_25_morse.blend``.


PR2 related Files
-----------------

- PR2 Collada file: ``$MORSE_ROOT/data/morse/robots/pr2/pr2.dae``
- PR2 original .blend Collada import: ``$MORSE_ROOT/data/morse/robots/pr2/pr2_25_original.blend``
- PR2 model with renamed objects: ``$MORSE_ROOT/data/morse/robots/pr2/pr2_25_rename.blend``
- PR2 model with MORSE integration: ``$MORSE_ROOT/data/morse/robots/pr2/pr2_25_morse.blend``
