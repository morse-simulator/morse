...
MORSE_DATASTREAM_DICT = {
    'ros': {
        ...
        'armature': ['read_joint_trajectory', 'morse/middleware/ros/joint_controller'],
        'armature_pose': ['post_jointstate', 'morse/middleware/ros/jointstate'],
        ...
        'hokuyo': ['post_2DLaserScan', 'morse/middleware/ros/sick'],
