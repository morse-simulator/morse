...
MORSE_MIDDLEWARE_DICT = {
    'ros': {
        ...
        'v_omega_diff_drive': [MORSE_MIDDLEWARE_MODULE['ros'], 'read_twist', 'morse/middleware/ros/read_vw_twist'],
    ...
    'socket': {
        ...
        'v_omega_diff_drive': [MORSE_MIDDLEWARE_MODULE['socket'], 'read_message'],
    ...
    'yarp': {
        ...
        'v_omega_diff_drive': [MORSE_MIDDLEWARE_MODULE['yarp'], 'read_message'],
    ...
    'pocolibs': {
        ...
        'v_omega_diff_drive': [MORSE_MIDDLEWARE_MODULE['pocolibs'], 'read_genpos', 'morse/middleware/pocolibs/actuators/genpos', 'simu_locoSpeedRef'],
