...
def post_odometry(self, component_instance):
    ...
    odometry.pose.pose.position.x = component_instance.local_data['dx']
    odometry.pose.pose.position.y = component_instance.local_data['dy']
    odometry.pose.pose.position.z = component_instance.local_data['dz']
...
def post_poseStamped(self, component_instance):
    ...
    poseStamped.pose.position.x = component_instance.local_data['dx']
    poseStamped.pose.position.y = component_instance.local_data['dy']
    poseStamped.pose.position.z = component_instance.local_data['dz']
    euler = mathutils.Euler((component_instance.local_data['droll'], component_instance.local_data['dpitch'], component_instance.local_data['dyaw']))
    quaternion = euler.to_quat()
