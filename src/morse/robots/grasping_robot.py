...
class GraspingRobot(Robot):
    ...
    def grasp(self, grab, obj_name=None):
        """
        Grasp near object
        grab is set to True to take an object and to false to release it.
        When obj_name is none, the robot will just grasp the 1st near object
        without any consideration for the object name.
        """
