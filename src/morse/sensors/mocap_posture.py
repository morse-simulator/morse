...
class HumanPostureClass(morse.core.sensor.MorseSensorClass):
    ...
    def default_action(self):
        ...
        logger.debug("\tTorso position: (%.4f, %.4f, %.4f)" % (torso.worldPosition[0], torso.worldPosition[1], torso.worldPosition[2]))
        ...
        logger.debug("\tTorso orientation: (%.4f, %.4f, %.4f)" % (self.local_data['roll'], self.local_data['pitch'], self.local_data['yaw']))
