...
class Joystick(Actuator):
    ...
    def default_action(self):
        ...
        """ TODO use joystick_sensor as:
        http://www.blender.org/documentation/blender_python_api_2_68_release/bge.types.SCA_JoystickSensor.html#bge.types.SCA_JoystickSensor
