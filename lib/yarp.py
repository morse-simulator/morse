...
class Value(Portable,Searchable):
    ...
    def isLeaf(*args): return _yarp.Value_isLeaf(*args)
...
class Contactable(_object):
    ...
    def isWriting(*args): return _yarp.Contactable_isWriting(*args)
...
class Port(Contactable):
    ...
    def setInputMode(*args): return _yarp.Port_setInputMode(*args)
    def setOutputMode(*args): return _yarp.Port_setOutputMode(*args)
    def setRpcMode(*args): return _yarp.Port_setRpcMode(*args)
...
class Bottle(Portable,Searchable):
    ...
    def hasChanged(*args): return _yarp.Bottle_hasChanged(*args)
...
class PropertyCallback(_object):
    ...
    __del__ = lambda self : None;
    def onRead(*args): return _yarp.PropertyCallback_onRead(*args)
    def __init__(self, *args): 
        if self.__class__ == PropertyCallback:
            args = (None,) + args
        else:
            args = (self,) + args
        this = _yarp.new_PropertyCallback(*args)
        try: self.this.append(this)
        except: self.this = this
    def __disown__(self):
        self.this.disown()
...
class BufferedPortProperty(Contactable,TypedReaderProperty,PropertyCallback):
    ...
    def isWriting(*args): return _yarp.BufferedPortProperty_isWriting(*args)
...
class BufferedPortBottle(Contactable,TypedReaderBottle,BottleCallback):
    ...
    def isWriting(*args): return _yarp.BufferedPortBottle_isWriting(*args)
...
class IControlModeRaw(_object):
    ...
    __del__ = lambda self : None;
    def setPositionModeRaw(*args): return _yarp.IControlModeRaw_setPositionModeRaw(*args)
    def setVelocityModeRaw(*args): return _yarp.IControlModeRaw_setVelocityModeRaw(*args)
    def setTorqueModeRaw(*args): return _yarp.IControlModeRaw_setTorqueModeRaw(*args)
    def getControlModeRaw(*args): return _yarp.IControlModeRaw_getControlModeRaw(*args)
...
class IControlMode(_object):
    ...
    __del__ = lambda self : None;
    def setPositionMode(*args): return _yarp.IControlMode_setPositionMode(*args)
    def setVelocityMode(*args): return _yarp.IControlMode_setVelocityMode(*args)
    def setTorqueMode(*args): return _yarp.IControlMode_setTorqueMode(*args)
    def getControlMode(*args): return _yarp.IControlMode_getControlMode(*args)
...
class ITorqueControlRaw(_object):
    ...
    def setTorqueModeRaw(*args): return _yarp.ITorqueControlRaw_setTorqueModeRaw(*args)
    def getTorqueRaw(*args): return _yarp.ITorqueControlRaw_getTorqueRaw(*args)
    def getTorquesRaw(*args): return _yarp.ITorqueControlRaw_getTorquesRaw(*args)
    ...
    def setTorquePidRaw(*args): return _yarp.ITorqueControlRaw_setTorquePidRaw(*args)
    def setTorquePidsRaw(*args): return _yarp.ITorqueControlRaw_setTorquePidsRaw(*args)
    def setTorqueErrorLimitRaw(*args): return _yarp.ITorqueControlRaw_setTorqueErrorLimitRaw(*args)
    def setTorqueErrorLimitsRaw(*args): return _yarp.ITorqueControlRaw_setTorqueErrorLimitsRaw(*args)
    def getTorqueErrorRaw(*args): return _yarp.ITorqueControlRaw_getTorqueErrorRaw(*args)
    def getTorqueErrorsRaw(*args): return _yarp.ITorqueControlRaw_getTorqueErrorsRaw(*args)
    def getTorquePidOutputRaw(*args): return _yarp.ITorqueControlRaw_getTorquePidOutputRaw(*args)
    def getTorquePidOutputsRaw(*args): return _yarp.ITorqueControlRaw_getTorquePidOutputsRaw(*args)
    def getTorquePidRaw(*args): return _yarp.ITorqueControlRaw_getTorquePidRaw(*args)
    def getTorquePidsRaw(*args): return _yarp.ITorqueControlRaw_getTorquePidsRaw(*args)
    def getTorqueErrorLimitRaw(*args): return _yarp.ITorqueControlRaw_getTorqueErrorLimitRaw(*args)
    def getTorqueErrorLimitsRaw(*args): return _yarp.ITorqueControlRaw_getTorqueErrorLimitsRaw(*args)
    def resetTorquePidRaw(*args): return _yarp.ITorqueControlRaw_resetTorquePidRaw(*args)
    def disableTorquePidRaw(*args): return _yarp.ITorqueControlRaw_disableTorquePidRaw(*args)
    def enableTorquePidRaw(*args): return _yarp.ITorqueControlRaw_enableTorquePidRaw(*args)
    def setTorqueOffsetRaw(*args): return _yarp.ITorqueControlRaw_setTorqueOffsetRaw(*args)
...
class ITorqueControl(_object):
    ...
    __del__ = lambda self : None;
    def getAxes(*args): return _yarp.ITorqueControl_getAxes(*args)
    def setTorqueMode(*args): return _yarp.ITorqueControl_setTorqueMode(*args)
    def getRefTorques(*args): return _yarp.ITorqueControl_getRefTorques(*args)
    def getRefTorque(*args): return _yarp.ITorqueControl_getRefTorque(*args)
    def setTorques(*args): return _yarp.ITorqueControl_setTorques(*args)
    def setTorque(*args): return _yarp.ITorqueControl_setTorque(*args)
    def setTorquePid(*args): return _yarp.ITorqueControl_setTorquePid(*args)
    def getTorque(*args): return _yarp.ITorqueControl_getTorque(*args)
    def getTorques(*args): return _yarp.ITorqueControl_getTorques(*args)
    def setTorquePids(*args): return _yarp.ITorqueControl_setTorquePids(*args)
    def setTorqueErrorLimit(*args): return _yarp.ITorqueControl_setTorqueErrorLimit(*args)
    def setTorqueErrorLimits(*args): return _yarp.ITorqueControl_setTorqueErrorLimits(*args)
    def getTorqueError(*args): return _yarp.ITorqueControl_getTorqueError(*args)
    def getTorqueErrors(*args): return _yarp.ITorqueControl_getTorqueErrors(*args)
    def getTorquePidOutput(*args): return _yarp.ITorqueControl_getTorquePidOutput(*args)
    def getTorquePidOutputs(*args): return _yarp.ITorqueControl_getTorquePidOutputs(*args)
    def getTorquePid(*args): return _yarp.ITorqueControl_getTorquePid(*args)
    def getTorquePids(*args): return _yarp.ITorqueControl_getTorquePids(*args)
    def getTorqueErrorLimit(*args): return _yarp.ITorqueControl_getTorqueErrorLimit(*args)
    def getTorqueErrorLimits(*args): return _yarp.ITorqueControl_getTorqueErrorLimits(*args)
    def resetTorquePid(*args): return _yarp.ITorqueControl_resetTorquePid(*args)
    def disableTorquePid(*args): return _yarp.ITorqueControl_disableTorquePid(*args)
    def enableTorquePid(*args): return _yarp.ITorqueControl_enableTorquePid(*args)
    def setTorqueOffset(*args): return _yarp.ITorqueControl_setTorqueOffset(*args)
...
class BufferedPortImageRgb(Contactable,TypedReaderImageRgb,TypedReaderCallbackImageRgb):
    ...
    def isWriting(*args): return _yarp.BufferedPortImageRgb_isWriting(*args)
...
class ImageRgba(Image):
    ...
    __repr__ = _swig_repr
    def getPixelSize(*args): return _yarp.ImageRgba_getPixelSize(*args)
    def getPixelCode(*args): return _yarp.ImageRgba_getPixelCode(*args)
    def pixel(*args): return _yarp.ImageRgba_pixel(*args)
    def access(*args): return _yarp.ImageRgba_access(*args)
    def safePixel(*args): return _yarp.ImageRgba_safePixel(*args)
    def __init__(self, *args): 
        this = _yarp.new_ImageRgba(*args)
        try: self.this.append(this)
        except: self.this = this
...
class TypedReaderImageRgba(_object):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    def setStrict(*args): return _yarp.TypedReaderImageRgba_setStrict(*args)
    def read(*args): return _yarp.TypedReaderImageRgba_read(*args)
    def interrupt(*args): return _yarp.TypedReaderImageRgba_interrupt(*args)
    def lastRead(*args): return _yarp.TypedReaderImageRgba_lastRead(*args)
    def isClosed(*args): return _yarp.TypedReaderImageRgba_isClosed(*args)
    def useCallback(*args): return _yarp.TypedReaderImageRgba_useCallback(*args)
    def disableCallback(*args): return _yarp.TypedReaderImageRgba_disableCallback(*args)
    def getPendingReads(*args): return _yarp.TypedReaderImageRgba_getPendingReads(*args)
    __swig_destroy__ = _yarp.delete_TypedReaderImageRgba
    __del__ = lambda self : None;
    def getName(*args): return _yarp.TypedReaderImageRgba_getName(*args)
    def setReplier(*args): return _yarp.TypedReaderImageRgba_setReplier(*args)
    def acquire(*args): return _yarp.TypedReaderImageRgba_acquire(*args)
    def release(*args): return _yarp.TypedReaderImageRgba_release(*args)
...
class TypedReaderCallbackImageRgba(_object):
    ...
    __del__ = lambda self : None;
    def onRead(*args): return _yarp.TypedReaderCallbackImageRgba_onRead(*args)
    def __init__(self, *args): 
        this = _yarp.new_TypedReaderCallbackImageRgba(*args)
        try: self.this.append(this)
        except: self.this = this
...
class BufferedPortImageRgba(Contactable,TypedReaderImageRgba,TypedReaderCallbackImageRgba):
    ...
    __del__ = lambda self : None;
    def addOutput(*args): return _yarp.BufferedPortImageRgba_addOutput(*args)
    def close(*args): return _yarp.BufferedPortImageRgba_close(*args)
    def interrupt(*args): return _yarp.BufferedPortImageRgba_interrupt(*args)
    def getPendingReads(*args): return _yarp.BufferedPortImageRgba_getPendingReads(*args)
    def where(*args): return _yarp.BufferedPortImageRgba_where(*args)
    def getName(*args): return _yarp.BufferedPortImageRgba_getName(*args)
    def prepare(*args): return _yarp.BufferedPortImageRgba_prepare(*args)
    def write(*args): return _yarp.BufferedPortImageRgba_write(*args)
    def writeStrict(*args): return _yarp.BufferedPortImageRgba_writeStrict(*args)
    def setStrict(*args): return _yarp.BufferedPortImageRgba_setStrict(*args)
    def read(*args): return _yarp.BufferedPortImageRgba_read(*args)
    def lastRead(*args): return _yarp.BufferedPortImageRgba_lastRead(*args)
    def isClosed(*args): return _yarp.BufferedPortImageRgba_isClosed(*args)
    def setReplier(*args): return _yarp.BufferedPortImageRgba_setReplier(*args)
    def onRead(*args): return _yarp.BufferedPortImageRgba_onRead(*args)
    def useCallback(*args): return _yarp.BufferedPortImageRgba_useCallback(*args)
    def disableCallback(*args): return _yarp.BufferedPortImageRgba_disableCallback(*args)
    def setEnvelope(*args): return _yarp.BufferedPortImageRgba_setEnvelope(*args)
    def getEnvelope(*args): return _yarp.BufferedPortImageRgba_getEnvelope(*args)
    def getInputCount(*args): return _yarp.BufferedPortImageRgba_getInputCount(*args)
    def getOutputCount(*args): return _yarp.BufferedPortImageRgba_getOutputCount(*args)
    def isWriting(*args): return _yarp.BufferedPortImageRgba_isWriting(*args)
    def getReport(*args): return _yarp.BufferedPortImageRgba_getReport(*args)
    def setReporter(*args): return _yarp.BufferedPortImageRgba_setReporter(*args)
    def acquire(*args): return _yarp.BufferedPortImageRgba_acquire(*args)
    def release(*args): return _yarp.BufferedPortImageRgba_release(*args)
...
class BufferedPortImageFloat(Contactable,TypedReaderImageFloat,TypedReaderCallbackImageFloat):
    ...
    def isWriting(*args): return _yarp.BufferedPortImageFloat_isWriting(*args)
