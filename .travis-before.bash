...
alias morsemake="rm -rf build && mkdir build && cd build && cmake -DBUILD_ROS_SUPPORT=ON .. && make && fakeroot make package && sudo dpkg -i ${PACKAGE_NAME}*.deb"
...
alias morseupload="$(pwd)/.travis-upload.bash ${PACKAGE_NAME}*.deb"
